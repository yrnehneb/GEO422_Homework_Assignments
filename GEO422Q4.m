...
%INPUT:
%
%mu         Population Expectation (In Q4's case, this represents the
%           end point of the uniform distribution)
%sig        Population Standard Deviation (In Q4's case, this represents the
%           beginning point of the uniform distribution)
